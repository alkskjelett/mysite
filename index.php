    ...
    <div class="wrapper">
        ...
        <div class="box box2">
            ...
            <div class="inner-box22">
                ...
                <p><button type="submit" class="submitbutton" >Авторизироваться</button></p>
                <p id="id1">У вас нет аккаунта? <a id="id2" href="signup.php">Зарегистрироваться</a>.</p>
                <p id="id1">Забыли пароль? <a id="id2" href="recovery.php">Восстановить</a>.</p>
            </div>
        </div>
